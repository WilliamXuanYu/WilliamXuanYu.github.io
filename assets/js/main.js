  ...
  en: {
    ...
    publicationsItems: [
      {
        ...
        tags: ["Closed-loop planning", "NAVSIM leaderboard best", "Trajectory ranking", "Candidate diversity"],
        links: [
      ...
      },
      {
        ...
        tags: ["VLA dual-system driving", "Representation complementarity", "NAVSIM VLA SOTA", "Fast inference"],
      ...
      },
      {
        ...
        tags: ["Scene-adaptive MoE", "BEV-conditioned routing", "Cross-modal causal attention", "Resource-efficient VLA"],
    ...
    projectItems: [
      ...
      },
      {
        ...
        tags: ["University of Alberta internship", "Computer vision research", "Forecasting models"]
      }
    ],
    educationItems: [
      {
    ...
    publicationsItems: [
      {
        ...
        tags: ["闭环规划", "NAVSIM leaderboard best", "轨迹排序", "候选轨迹多样性"],
        links: [
          { label: "Paper", url: "https://arxiv.org/abs/2605.15120", icon: "file-text" },
          { label: "Code", url: "https://github.com/WilliamXuanYu/CLOVER", icon: "github" }
        ]
      ...
      },
      {
        ...
        tags: ["VLA 双系统驾驶", "表征互补性分析", "NAVSIM VLA SOTA", "高效推理"],
        links: [{ label: "Paper", url: "https://arxiv.org/abs/2602.10719", icon: "file-text" }]
      },
      {
        title: "DriveFine: Refining-Augmented Masked Diffusion VLA for Precise and Robust Driving",
      ...
      },
      {
        ...
        tags: ["场景自适应 MoE", "BEV 条件路由", "跨模态因果注意力", "资源高效 VLA"],
        links: [{ label: "Paper", url: "https://arxiv.org/abs/2603.08113", icon: "file-text" }]
      },
      {
        title: "Deployment and Optimization of MapTR-based Lane Detection on Huawei MDC610",
